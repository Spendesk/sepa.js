...
(function(exports) {
  ...
  SepaGroupHeader.prototype = {
    ...
    cifNumber: '',
    /**
     * Used by portuguese bank and mandatory for them.
     */
    portugueseVAT: '',
    /**
    ...
    toXML: function(doc) {
      ...
      if (this.portugueseVAT) {
        r(initgPty, 'Id', 'PrvtId', 'Othr', 'Id', this.portugueseVAT);
      }
      if (this.cucNumber) {
  ...
  function assert_debitor({
    ...
    try {
      ...
      message = 'Invalid BIC/IBAN for ' + pullFrom + ' called ' + name + ' with BIC: ' + bic + ' and IBAN: ' + iban;
